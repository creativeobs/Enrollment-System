...
Public Class Form3
    ...
    Private Sub dtgrd()
        ...
        conn.Close()
        DataGridView1.Columns("Employee Number").Visible = False
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If sn.Text = Nothing Then
            MessageBox.Show("Fill up all the fields", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Exit Sub
        ElseIf d.Text = Nothing Then
            MessageBox.Show("Fill up all the fields", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Exit Sub
        ElseIf t.Text = Nothing Then
            MessageBox.Show("Fill up all the fields", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Exit Sub
        ElseIf rn.Text = Nothing Then
            MessageBox.Show("Fill up all the fields", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Exit Sub
        End If
        ...
        If cho = 1 Then
            ...
            DataGridShow(sn.Text)
            If DataGridView2.RowCount > 1 Then
                MessageBox.Show("Section Name is already listed.", "WARNING", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Exit Sub
            End If
            ...
            conn.Open()
            Try
                sqlquery.CommandText = "Insert into [Section] ([Section], [Class Adviser], [Day], [Time], [Room Number]) VALUES ('" & sn.Text & "', '" & na & "', '" & d.Text & "', '" & t.Text & "', '" & rn.Text & "');"
        ...
        ElseIf cho = 2 Then
            ...
            DataGridShow(sn.Text)
            If DataGridView2.RowCount > 1 And str(0) <> sn.Text Then
            ...
            While ct <> 2
                ...
                Try
                    If ct = 0 Then
                        sqlquery.CommandText = "Delete from [Section] WHERE [Section] = '" & str(0) & "';"
                    ElseIf ct = 1 Then
                        sqlquery.CommandText = "Insert into [Section] ([Section], [Class Adviser], [Day], [Time], [Room Number]) VALUES ('" & sn.Text & "', '" & na & "', '" & d.Text & "', '" & t.Text & "', '" & rn.Text & "');"
                    End If
                    sqlquery.ExecuteNonQuery()
...
a:
    ...
    Private Sub DataGridShow(str As String)
        ...
        ds.Tables.Add(dt)
        Dim da As New OleDbDataAdapter
        da = New OleDbDataAdapter("Select * from [Section] WHERE [Section]= '" & str & "';", conn)
        da.Fill(dt)
