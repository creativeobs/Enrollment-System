...
Public Class Form8
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        If txtSubcode.Text = Nothing Then
            MessageBox.Show("Fill up all the fields", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Exit Sub
        ElseIf txtDes.Text = Nothing Then
            MessageBox.Show("Fill up all the fields", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Exit Sub
        ElseIf txtUnit.Text = Nothing Then
            MessageBox.Show("Fill up all the fields", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Exit Sub
        ElseIf txtsubname.Text = Nothing Then
            MessageBox.Show("Fill up all the fields", "Warning", MessageBoxButtons.OK, MessageBoxIcon.Warning)
            Exit Sub
        End If
        ...
        If cho = 1 Then
            ...
            DataGridShow(txtSubcode.Text)
            If DataGridView2.RowCount > 1 Then
                MessageBox.Show("Subject Code is already listed.", "WARNING", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Exit Sub
            End If
            ...
            sqlquery.Connection = conn
                ...
                sqlquery.CommandText = "Insert into Subject ([Subject Code], [Subject Name], [Description], [Unit]) VALUES ('" & txtSubcode.Text & "', '" & txtsubname.Text & "', '" & txtDes.Text & "', '" & txtUnit.Text & "');"    
        ...
        ElseIf cho = 2 Then
            ...
            While ct <> 2
                ...
                Try
                    If ct = 0 Then
                        sqlquery.CommandText = "Delete from Subject WHERE [Subject Code] = '" & str(0) & "';"
                    ElseIf ct = 1 Then
                        sqlquery.CommandText = "Insert into Subject ([Subject Code], [Subject Name], [Description], [Unit]) VALUES ('" & txtSubcode.Text & "', '" & txtsubname.Text & "', '" & txtDes.Text & "', '" & txtUnit.Text & "');"
                   End If
                    sqlquery.ExecuteNonQuery()
...
a:
    ...
    Private Sub DataGridShow(str As String)
        ...
        ds.Tables.Add(dt)
        Dim da As New OleDbDataAdapter
        da = New OleDbDataAdapter("Select * from Subject WHERE [Subject Code]= '" & str & "';", conn)
        da.Fill(dt)
    ...
    Private Sub btnEdit_Click(sender As Object, e As EventArgs) Handles btnEdit.Click
        ...
        txtDes.Enabled = True
        txtUnit.Enabled = True
        txtSubcode.Text = str(0)
        txtsubname.Text = str(1)
        txtDes.Text = str(2)
        txtUnit.Text = str(3)
        txtSubcode.Focus()
        cho = 2
    ...
    Private Sub btnDelete_Click(sender As Object, e As EventArgs) Handles btnDelete.Click
        If str(0) = Nothing Then
            ...
            Exit Sub
        End If
        Dim ans As Integer = MessageBox.Show("Are you sure you want to delete this Subject?", "Subject", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
        If ans = DialogResult.Yes Then
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles TextBox1.TextChanged
        If TextBox1.TextLength >= 1 Then
            ...
            ds.Tables.Add(dt)
            Dim da As New OleDbDataAdapter
            da = New OleDbDataAdapter("SELECT * FROM Subject WHERE [" & ComboBox1.Text & "] LIKE '" & TextBox1.Text & "%'", conn)
            da.Fill(dt)
            DataGridView1.DataSource = dt.DefaultView
            conn.Close()
            For x As Integer = 0 To DataGridView1.RowCount - 1
